...
/* returns rendered hbs as html */

Handlebars.registerHelper('bioCodeInclude', function(partialName, context) {
  if (typeof partialName !== 'string') {
    return '';
  }
  ...
  if (!partial) {
    console.log(
      'partial ' +
        partialName +
        ' not found: block helper fallback will be used'
    );
    return context.fn(this);
  }

  var partialData = deepMergeObjectsIntoNew(this, context);
